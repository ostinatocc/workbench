...
from aionis_workbench.e2e.real_e2e.scenario_runner import (
    ...
    run_live_ab_test_ui_refinement_compare_scenario,
)


def test_live_ab_test_ui_refinement_report_real_scenario(tmp_path) -> None:
    ...
    result = run_live_ab_test_ui_refinement_compare_scenario(
        repo_entry,
        cache_root=tmp_path / ".real-e2e-cache",
        launcher_home=tmp_path / ".aionis-live-home",
    )
    ...
    assert result.details["benchmark_scenario_id"] == "stateful-ui-workflow-refinement"
